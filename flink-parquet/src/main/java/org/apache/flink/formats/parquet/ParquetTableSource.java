...
//	implements DynamicTableSource, FilterableTableSource<Row>, ProjectableTableSource<Row> {
//
...
//		return new ParquetTableSource(path, parquetSchema, configuration, recursiveEnumeration);
//	}
//
//	@Override
